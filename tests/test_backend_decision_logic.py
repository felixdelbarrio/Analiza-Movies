...
def test_sort_filtered_rows_orders_by_decision_and_votes():
    rows = [
        ...
        {"decision": "DELETE", "imdb_votes": 10, "imdb_rating": 1.0, "title": "Delete A"},
        {"decision": "MAYBE", "imdb_votes": 999, "imdb_rating": 5.0, "title": "Maybe A"},
        {"decision": "DELETE", "imdb_votes": 200, "imdb_rating": 1.0, "title": "Delete B"},
    ]
