...
# Directorio del módulo backend/ dentro de src/
...
# ============================================================
# Logs del backend viven fuera de src/ para no ensuciar el árbol de código.

LOGGER_FILE_ENABLED: bool = _get_env_bool("LOGGER_FILE_ENABLED", False)

_LOGGER_FILE_DIR_RAW: Final[str] = _get_env_str(
    "LOGGER_FILE_DIR", str(PROJECT_DIR / "logs" / "backend")
) or str(PROJECT_DIR / "logs" / "backend")
...
LOGGER_FILE_DIR: Final[Path] = (
    ...
    else (PROJECT_DIR / _LOGGER_FILE_DIR_CANDIDATE)
)
