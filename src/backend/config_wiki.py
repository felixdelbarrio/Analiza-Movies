...
WIKI_CLIENT_DISABLE_INFO_LOGS: bool = _get_env_bool(
    "WIKI_CLIENT_DISABLE_INFO_LOGS", False
)
WIKI_ANALYZE_WORKERS: int = _cap_int(
    "WIKI_ANALYZE_WORKERS",
    _get_env_int("WIKI_ANALYZE_WORKERS", 8),
    min_v=1,
    max_v=64,
)
WIKI_MAX_INFLIGHT_FACTOR: int = _cap_int(
    "WIKI_MAX_INFLIGHT_FACTOR",
    _get_env_int("WIKI_MAX_INFLIGHT_FACTOR", 4),
    min_v=1,
    max_v=64,
)
WIKI_PROGRESS_EVERY_N_ITEMS: int = _cap_int(
    "WIKI_PROGRESS_EVERY_N_ITEMS",
    _get_env_int("WIKI_PROGRESS_EVERY_N_ITEMS", 200),
    min_v=1,
    max_v=1_000_000,
)
...
WIKI_CACHE_JSON_INDENT: int = _cap_int(
    "WIKI_CACHE_JSON_INDENT",
    _get_env_int("WIKI_CACHE_JSON_INDENT", 2),
    min_v=0,
    max_v=8,
)
...
# Nombres actuales (los usa wiki_client.py):
...
# ============================================================
# ✅ SWR (stale-while-revalidate) para items OK
# ============================================================
...
# ============================================================
# ✅ cache de candidatos de búsqueda Wikipedia
# ============================================================
...
# ============================================================
# ✅ single-flight (espera a que otro hilo complete)
# ============================================================
