...
from backend.config_collection import COLLECTION_TRACE_LINE_MAX_CHARS
from backend.config_core import (
...
# Knobs del core
# =============================================================================
_METRICS_ENABLED: Final[bool] = ANALYZE_CORE_METRICS_ENABLED
_METRICS_LAZY_BIND_ENABLED: Final[bool] = ANALYZE_METRICS_LAZY_BIND_ENABLED

_TRACE_LINE_MAX_CHARS: Final[int] = COLLECTION_TRACE_LINE_MAX_CHARS
_TRACE_REASON_MAX_CHARS: Final[int] = ANALYZE_TRACE_REASON_MAX_CHARS

# Inconsistencias (solo observación; NO cambia decisiones)
_INCONS_DELETE_MIN_RATING: Final[float] = ANALYZE_INCONSISTENCY_DELETE_IMDB_MIN_RATING
_INCONS_DELETE_MIN_VOTES: Final[int] = ANALYZE_INCONSISTENCY_DELETE_IMDB_MIN_VOTES

_INCONS_KEEP_MAX_RATING: Final[float] = ANALYZE_INCONSISTENCY_KEEP_IMDB_MAX_RATING
_INCONS_KEEP_MIN_VOTES: Final[int] = ANALYZE_INCONSISTENCY_KEEP_IMDB_MIN_VOTES

# Fallback de lookup_title
_LOOKUP_TITLE_FALLBACK_ENABLED: Final[bool] = ANALYZE_LOOKUP_TITLE_FALLBACK_ENABLED
_LOOKUP_TITLE_FALLBACK_MAX_CHARS: Final[int] = ANALYZE_LOOKUP_TITLE_FALLBACK_MAX_CHARS

# Métrica heurística
_STRONG_POTENTIAL_CONTRADICTION_ENABLED: Final[bool] = (
    ANALYZE_METRICS_STRONG_POTENTIAL_CONTRADICTION_ENABLED
)
