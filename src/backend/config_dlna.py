...
DLNA_SCAN_WORKERS: int = _cap_int(
    "DLNA_SCAN_WORKERS", _get_env_int("DLNA_SCAN_WORKERS", 2), min_v=1, max_v=8
)
...
DLNA_CB_OPEN_SECONDS: float = _cap_float_min(
    "DLNA_CB_OPEN_SECONDS", _get_env_float("DLNA_CB_OPEN_SECONDS", 20.0), min_v=0.1
)
...
DLNA_DISCOVERY_MX: int = _cap_int(
    "DLNA_DISCOVERY_MX", _get_env_int("DLNA_DISCOVERY_MX", 2), min_v=1, max_v=10
)
...
DLNA_DISCOVERY_MAX_RESPONSES: int = _cap_int(
    "DLNA_DISCOVERY_MAX_RESPONSES",
    _get_env_int("DLNA_DISCOVERY_MAX_RESPONSES", 2048),
    min_v=64,
    max_v=100_000,
)
DLNA_DISCOVERY_MAX_RESPONSES_PER_HOST: int = _cap_int(
    "DLNA_DISCOVERY_MAX_RESPONSES_PER_HOST",
    _get_env_int("DLNA_DISCOVERY_MAX_RESPONSES_PER_HOST", 512),
    min_v=32,
    max_v=10_000,
)

_DLNA_DISCOVERY_DENY_TOKENS_RAW: str = (
    _get_env_str(
...
DLNA_DISCOVERY_DENY_TOKENS: list[str] = _parse_env_csv_tokens(
    _DLNA_DISCOVERY_DENY_TOKENS_RAW
)

_DLNA_DISCOVERY_ALLOW_HINT_TOKENS_RAW: str = (
    _get_env_str(
...
DLNA_DISCOVERY_ALLOW_HINT_TOKENS: list[str] = _parse_env_csv_tokens(
    _DLNA_DISCOVERY_ALLOW_HINT_TOKENS_RAW
)
