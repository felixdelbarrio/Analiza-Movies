...
OMDB_CACHE_FILENAME: Final[str] = _get_env_str("FRONT_OMDB_CACHE_FILENAME", "omdb_cache.json") or "omdb_cache.json"
WIKI_CACHE_FILENAME: Final[str] = _get_env_str("FRONT_WIKI_CACHE_FILENAME", "wiki_cache.json") or "wiki_cache.json"
...
METADATA_FIX_FILENAME: Final[str] = _get_env_str("FRONT_METADATA_FIX_FILENAME", "metadata_fix.csv") or "metadata_fix.csv"
REPORT_ALL_FILENAME: Final[str] = _get_env_str("FRONT_REPORT_ALL_FILENAME", "report_all.csv") or "report_all.csv"
REPORT_FILTERED_FILENAME: Final[str] = _get_env_str("FRONT_REPORT_FILTERED_FILENAME", "report_filtered.csv") or "report_filtered.csv"
