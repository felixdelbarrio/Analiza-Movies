...
PLEX_ANALYZE_WORKERS: int = _cap_int("PLEX_ANALYZE_WORKERS", _get_env_int("PLEX_ANALYZE_WORKERS", 8), min_v=1, max_v=64)
...
PLEX_MAX_WORKERS_CAP: int = _cap_int("PLEX_MAX_WORKERS_CAP", _get_env_int("PLEX_MAX_WORKERS_CAP", 64), min_v=1, max_v=512)
PLEX_MAX_INFLIGHT_FACTOR: int = _cap_int("PLEX_MAX_INFLIGHT_FACTOR", _get_env_int("PLEX_MAX_INFLIGHT_FACTOR", 4), min_v=1, max_v=50)
...
PLEX_METRICS_TOP_N: int = _cap_int("PLEX_METRICS_TOP_N", _get_env_int("PLEX_METRICS_TOP_N", 5), min_v=1, max_v=50)
